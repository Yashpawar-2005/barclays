  ...
  return (
    <>
      ...
      `}>
        ...
        <div className="p-4">
  <div className="w-full flex items-center justify-center gap-2 bg-black text-white font-medium py-2 px-4 rounded-md shadow-sm text-sm">
    <span>You're viewing your organizations</span>
  </div>
</div>
