...
// src/components/comps/Documentprocessing/Output.tsx
import React, { useState, useEffect } from "react";
import { useParams } from "react-router-dom";
import { api } from "../../../services/axios";
...
const Output: React.FC = () => {
  ...
  return (
    <div className="h-full relative bg-white">
      {/* Scrollable PDF + Chat */}
      <div className="absolute inset-0 overflow-auto pb-24 p-4">
        {/* PDF Viewer */}
        <div className="mb-4">
          {loadingPdf && <p>Loading document…</p>}
          {errorPdf && <p className="text-red-500">{errorPdf}</p>}
          {validatedUrl && (
            <iframe
              src={validatedUrl}
              title="Validated Termsheet"
