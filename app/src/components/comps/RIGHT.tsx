      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="">
          <div className="flex items-center">
            ...
            {/* <div className="h-12 w-48 bg-black rounded flex items-center justify-center text-white font-bold overflow-hidden">
              <img src='../../../public/images/logo.jpg' alt="Company Logo" className="h-full w-full object-cover" />
            </div> */}
          </div>
        </div>
